...
// Puis on en extrait le nom de la famille.
const family = path.substring(1)

/**
 * getProductsByFamily est la fonction qui fait une requête au serveur backend pour avoir tous les instruments 
 * en fonction de leur famille, et qui appelle displayProducts pour afficher directement tous les produits.
 */
function getProductsByFamily() {
    fetch(urlAPI + "getProductsByFamily/" + family)
...
/**
 * displayProducts est la fonction qui affiche tous les instruments disponibles, obtenus grâce à getProductsByFamily.
...
window.addEventListener('load', getProductsByFamily)